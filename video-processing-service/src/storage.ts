...
const rawVideoBucketName = "yt-skel-raw-videos";
const processedVideoBucketName = "yt-skel-processed-videos";
...
export async function downloadRawVideo(fileName: string) {
  ...
  console.log(
    `gs://${localRawVideoPath}/${fileName} downloaded to ${localRawVideoPath}/${fileName}`
  );
}
 ...
 * @param {string} dirPath - The directory paht to check.
 */
